...
print(df_table_books.to_sql(name="Books", con=engine, if_exists="append", index=False))
print(df_table_price.to_sql(name="Price", con=engine, if_exists="append", index=False))
print(df_table_books_info.to_sql(name="BooksInfo", con=engine, if_exists="append", index=False))
print(df_table_tags.to_sql(name="Tags", con=engine, if_exists="append", index=False))
print(df_table_persons.to_sql(name="Persons", con=engine, if_exists="append", index=False))
print(df_table_publishers.to_sql(name="Publishers", con=engine, if_exists="append", index=False))
print(df_table_book_publishers.to_sql(name="BookPublishers", con=engine, if_exists="append", index=False))
print(df_table_book_authors.to_sql(name="BookAuthors", con=engine, if_exists="append", index=False))
print(df_table_book_translators.to_sql(name="BookTranslators", con=engine, if_exists="append", index=False))
print(df_table_book_illustrators.to_sql(name="BookIllustrators", con=engine, if_exists="append", index=False))
print(df_table_book_editors.to_sql(name="BookEditors", con=engine, if_exists="append", index=False))
print(df_table_book_speakers.to_sql(name="BookSpeakers", con=engine, if_exists="append", index=False))
print(df_table_book_tags.to_sql(name="BookTags", con=engine, if_exists="append", index=False))